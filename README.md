...
## Algorithm
1. Import the required libraries and load the dataset containing study hours and marks scored.
2. Split the dataset into training and testing data.
3. Train the Simple Linear Regression model using the training dataset.
4. Predict the marks using the test data and display the results with a regression graph.
